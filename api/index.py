...
if USE_FLASK:
    ...
    def soso_api_index():
        api_key_header = request.headers.get("x-api-key") or request.headers.get("X-API-Key") or request.headers.get("Authorization")
...
if __name__ == "__main__":
    ...
    if USE_FLASK:
        ...
        print(f"[Python] Starting HTTPServer on port {port}...")
