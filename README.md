...
Copy .env.example to .env and populate your SOSO_API_KEY, TELEGRAM_TOKEN, and AUTHORIZED_AUDITOR_ADDRESS.
...
Backend Setup:
The Flask backend is located in /api. For local testing, ensure dependencies are installed:

pip install -r requirements.txt

 Backtest Performance
Current 7-Day Alpha Capture: 17.0%
Governance Address: 0x42f883654e954c29c8e8E06A5884B2B36b80E921
Protocol Status: Wave 2 Production Ready