...
import { useExecuteNeuralSignal } from './hooks/useExecuteNeuralSignal';
...
import { RiskAuditFeed } from './components/RiskAuditFeed';
import { OnChainLedger, OnChainLedgerEntry } from './components/OnChainLedger';
...
--------------------------------------------------
  ...
  const handleExecute = async () => {
    ...
    try {
      const prepRes = await fetch("/api/prepare-execution", { method: "POST" });
